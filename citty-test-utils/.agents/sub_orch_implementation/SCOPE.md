...
|---|------|-------|--------------|--------|-----------------|
| 1 | Backward-Compatible Runner Signatures (R1) | Update `local-runner.js` to accept `(argsOrOptions, options)` and wrap results in `wrapExpectation` | None | DONE | Worker: 407e6b6a-1557-4ba5-959e-9fc4be20117f, Rev: 0e456dd8-81fa-45a4-a974-3a1a7f8f262c, Chall: 26d8dd0a-68ac-44e9-9a42-0e37e6b3ade0, Aud: 2710db03-eb7c-4e39-9234-bb4e64ce2314 |
| 2 | Scenario DSL .run() & Validation (R2, R3) | Implement `.run()` chaining and fix "no command" validation in `scenario-dsl.js` | M1 | IN_PROGRESS | d3e611c0-3090-4016-8f2c-126fe4e7b06a |
